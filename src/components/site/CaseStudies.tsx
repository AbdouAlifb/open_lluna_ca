    ...
    <SectionTitle title="Case Studies" watermark="Results" className="mb-6 md:mb-10" />
        ...
        <div className="space-y-12 md:space-y-16">
          {STUDIES.map((s, idx) => {
            ...
            const fromSide =
              imageLeft
                ? "translate-y-6 md:-translate-x-6" // image on left -> slide from left on desktop
                : "translate-y-6 md:translate-x-6"; // image on right -> slide from right on desktop
            ...
            return (
              ...
              >
                ...
                <div
                  className={[
                    "md:col-span-7",
                    imageLeft ? "order-1" : "order-2 md:col-start-6",
                  ].join(" ")}
                >
                  <div
                    className="
                      group relative aspect-[16/10] w-full overflow-hidden rounded-3xl ring-1 ring-black/5
                ...
                <div
                  className={[
                    "md:col-span-5",
                    imageLeft ? "order-2 md:col-start-9" : "order-1 md:col-start-1",
                  ].join(" ")}
                >
